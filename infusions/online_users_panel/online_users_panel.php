...
$result = dbquery("DELETE FROM ".DB_ONLINE." WHERE online_lastactive<".(time()-500)."");
...
echo THEME_BULLET." ".$locale['global_014'].": ".number_format(dbcount("(user_id)", DB_USERS, "user_status<='1'"))."<br />\n";
