...
if ($rows) {
	...
	while ($data = dbarray($result)) {
		...
		echo "<td class='".$row_color."' style='text-align:center;white-space:nowrap'>".alias2($data['thread_lastpost_alias'], alias1($data['user_aliases2']), $data['user_id2'], $data['user_name2'], $data['user_status2'])."<br />
